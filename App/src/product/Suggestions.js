...
//import ShoppingBasketIcon from 'BsFillCartCheckFill';
  ...
  render() {
    ...
    return (<div>
      <Paper className={classes.root} elevation={4}>
        ...
        {Array.isArray(this.props.products)?this.props.products.map((item, i) => {
            return <span key={i}>
                ...
                <div className={classes.details}>
                  <CardContent className={classes.content}>
                    ...
                    <Link to={'/shops/'+item.shop}>
                      ...
                      <i class="cis-basket"></i>
                      </Typography>
                    </Link>
                    <Typography component="p" className={classes.date}>
                        Aniadido el {(new Date(item.created)).toDateString()}
                    </Typography>
                  </CardContent>
