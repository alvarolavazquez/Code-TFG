...
router.route("/:shopId/:productId").put(authCtrl.requireSignin, shopCtrl.isOwner, productCtrl.update);

router.route("/:shopId/:productId").delete(authCtrl.requireSignin, shopCtrl.isOwner, productCtrl.remove);

router.route("/by/:shopId").get(productCtrl.listByShop).post(authCtrl.requireSignin, shopCtrl.isOwner, productCtrl.create);
